<x-guest-layout>
    <div class="max-w-6xl mx-auto mt-1 bg-gray">
                        ...
                        <ul role="list" class="space-y-6">
                            ...
                            <li class="bg-white px-4 py-6 shadow rounded-sm">
                                <div class="flex justify-center">
                                        ...
                                        <div class="flex">
                                            <div class="flex-1 overflow-flex-wrap">
                                                <h2 class="text-xl font-bold text-gray-900 mb-1">
                                                    <a href={{ route('course.show',  $course->slug) }} class="text-blue-500 hover:underline">{{$course->name}} - {{$course->difficulty_level}}</a>
                                                </h2>
                                    ...
                                    <div class="flex w-2/12 overflow-hidden justify-end">
                                        @foreach ( $course->authors as $author )
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white" src="{{ asset('assets/images/authors/') }}/{{ $author->image }}.png" alt="{{ $author->name }}">
                                        @endforeach
                                    </div>
                                </div>
                            </li>
